...
// 	private void ConnectedToServer()
// 	{
// 		GD.Print($"Connected to server: {Multiplayer.GetUniqueId()}");
// 		AddPlayer("Jorma", Multiplayer.GetUniqueId());
// 	}
